...
import input_module_otx as input_module
...
'''
    ...
    Add your modular input logic to file input_module_otx.py
'''
class ModInputotx(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputotx, self).__init__("ta_otx", "otx", use_single_instance)
...
if __name__ == "__main__":
    exitcode = ModInputotx().run(sys.argv)
    sys.exit(exitcode)
